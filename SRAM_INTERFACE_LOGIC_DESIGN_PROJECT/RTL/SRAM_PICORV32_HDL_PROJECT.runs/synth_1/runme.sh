...
HD_PWD='D:/SRAM_PICORV32_HDL_PROJECT/SRAM_PICORV32_HDL_PROJECT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log picorv32_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source picorv32_top.tcl
