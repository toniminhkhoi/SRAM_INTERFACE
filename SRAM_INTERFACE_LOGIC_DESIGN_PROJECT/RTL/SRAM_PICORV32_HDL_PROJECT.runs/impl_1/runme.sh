...
HD_PWD='D:/SRAM_PICORV32_HDL_PROJECT/SRAM_PICORV32_HDL_PROJECT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log picorv32_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source picorv32_top.tcl -notrace
